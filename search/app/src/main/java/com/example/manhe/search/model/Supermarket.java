...
public class Supermarket {
    ...
    private ArrayList<Integer> listIdService;

    private String phonnumber,roadguide,time_open,time_close;
    private ArrayList<Integer> listTag;
    private String style;

    public Supermarket(String cate, String id_d, String lat, String lng,
                       ...
                       ArrayList<Image> imageArrayList, ArrayList<Integer> listIdService,
                       String phonnumber, String roadguide, String time_open, String time_close,ArrayList<Integer> listTag,String style) {
        this.cate = cate;
        this.id_d = id_d;
        this.lat = lat;
        this.lng = lng;
